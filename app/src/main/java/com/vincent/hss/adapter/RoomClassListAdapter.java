...
public class RoomClassListAdapter extends RecyclerView.Adapter<RoomClassListAdapter.RoomClassListViewHolder> {
    private Context context;
    private List<String> data;
    private CommonOnClickListener clickListener;

    public  RoomClassListAdapter(Context context) {
